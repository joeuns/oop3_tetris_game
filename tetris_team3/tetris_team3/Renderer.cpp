...
void Renderer::drawLogo() {
    setColor(WHITE);
    gotoXY(13, 3);  std::cout << "旨收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收旬";
    gotoXY(13, 4);  std::cout << "早﹣ ﹣ ﹣  ﹣﹣﹣  ﹣ ﹣ ﹣   ﹣﹣     ﹣   ﹣ ﹣ ﹣         早";
    gotoXY(13, 5);  std::cout << "早  ﹣    ﹣      ﹣     ﹣ ﹣    ﹣   ﹣             早";
    gotoXY(13, 6);  std::cout << "早  ﹣    ﹣﹣﹣    ﹣     ﹣﹣     ﹣     ﹣           早";
    gotoXY(13, 7);  std::cout << "早  ﹣    ﹣      ﹣     ﹣ ﹣    ﹣       ﹣         早";
    gotoXY(13, 8);  std::cout << "早  ﹣    ﹣﹣﹣    ﹣     ﹣  ﹣   ﹣   ﹣ ﹣ ﹣         早";
    gotoXY(13, 9);  std::cout << "曲收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收收旭";
...
void Renderer::drawGameOver() {
    ...
    std::vector<std::string> gameOverMsg = {
        "旨收收收收收收收收收收收收收收收收收收收收收收收收收收旬",
        "早      G A M E  O V E R      早",
        "曲收收收收收收收收收收收收收收收收收收收收收收收收收收旭"
    };
